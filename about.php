...
<main class="containerheader">
    ...
    <section class="banner">
        ...
        <img class="banner__img banner__img--no-border" src="<?= $a->about->acf->banner->imagen ?>" />
    </section>

    <!-- ADD-ONS -->
    <section class="add-on add-on--left add-on--end"
        style="display: flex;align-items: center;gap: 30px;width:100%;max-width:1000px;padding: 50px 25px;">
