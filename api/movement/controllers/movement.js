...
module.exports = {
  ...
  // Al llegar a la dirección en la cual la suscrbición se completa d eforma exitosa se debe hacer una petición a este endpoint
  async success_aggrement(ctx) {
    ...
    paypal.billingAgreement.execute(token, function (error, billingAgreement) {
      if (error) {
        ...
        strapi.services.movement.create({ paypal: JSON.stringify(billingAgreement), daycare: organization, payer: id, category: '60b0ed8db83e2f4588f879a1', extra_info: 'Creación de suscribción de PayPal.' });
