...
<body>
    <header>
        ...
        <div class="overlay" id="mobile-menu">
            ...
            <div class="overlay-content">
                ...
                <a onclick="closeNav()" href="#https://wa.me/<?= $info->acf->telefono ?>;" target="_blank">Contact
                    Us</a>
                <a onclick="closeNav()" href="https://wa.me/<?= $info->acf->telefono ?>;" target="_blank"
                    class="btn"><button>
    ...
    <main>
        ...
        <?php
        if (
            $info->acf->networks_social_media->facebook != "" ||
